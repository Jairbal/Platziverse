...
const { configDB, handleFatalError, handleError, parsePayload } = require('platziverse-utils')
...
server.listen(port, (error) => {
  if (!error) {
    console.log(`${chalk.green('[platziverse-mqtt]')} Server runingn on port ${port}`)
  } else {
