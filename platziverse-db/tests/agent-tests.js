...
test.serial('Agent#findById', async t => {
  ...
  t.true(AgentStub.findById.calledWith(id), 'findById should be calle with specified id')

  t.deepEqual(agent, agentFixtures.byId(id), 'should be the same')
})

test.serial('Agente#findByUuid', async t => {
...
test.serial('Agent#findAll', async t => {
  ...
  t.is(agents.length, agentFixtures.all.length, 'agents should be the some amount')
...
test.serial('Agente#createOrUpdate -new', async t => {
  ...
  }), 'findOne should be called with uuid arg')
